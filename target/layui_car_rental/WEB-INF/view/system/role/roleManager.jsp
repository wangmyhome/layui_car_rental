...
<script type="text/javascript">
    ...
    layui.extend({
        ...
        tableIns = table.render({
            ...
            , url: '${base}/role/loadAllRole.action' //数据接口
        ...
        $("#doSearch").click(function () {
            ...
            //alert(params);
            tableIns.reload({
                url: "${base}/role/loadAllRole.action?" + params,
                page:{curr:1}
            })
        });
        ...
        table.on('tool(roleTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.rolename + '】这个角色么？', function (index) {
                    //向服务端发送删除指令
                    $.post("${base}/role/deleteRole.action", {roleid: data.roleid}, function (res) {
                        layer.msg(res.msg);
                        //刷新数据表格
                        tableIns.reload();
                    })
        ...
        function openUpdateRole(data) {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    url = "${base}/role/updateRole.action";
                }
            });
        }
        ...
        function deleteBatch() {
            ...
            layer.confirm('真的要删除这些角色么？', function (index) {
                //向服务端发送删除指令
                $.post("${base}/role/deleteBatchRole.action",params, function (res) {
                    layer.msg(res.msg);
                    //刷新数据表格
                    tableIns.reload();
                })
        ...
        function openselectRoleMenu(data) {
            ...
            mainIndex=layer.open({
                ...
                yes:function (index, layero) {
                    ...
                    //保存角色和菜单的关系
                    $.post("${base}/role/saveRoleMenu.action",params,function (obj) {
                        layer.msg(obj.msg);
                        //关闭弹出层
                        layer.close(mainIndex);
                    })
                ...
                success:function (index) {
                    ...
                    menuTree = dtree.render({
                        ...
                        checkbarType:"all",
                        checkbarData:"choose",
                        url: "${base}/role/initRoleMenuTreeJson.action?roleid="+data.roleid
                    });
