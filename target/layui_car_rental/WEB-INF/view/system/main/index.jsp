...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="${base}/static/images/face.jpg" class="layui-nav-img userAvatar"
                                                width="35" height="35"><cite
                            class="adminName">${user.realname}</cite></a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" data-url="${base}/static/page/user/userInfo.html"><i
                                class="seraph icon-ziliao" data-icon="icon-ziliao"></i><cite>个人资料</cite></a></dd>
                        <dd><a href="javascript:;" data-url="${base}/static/page/user/changePwd.html"><i
                        ...
                        <dd><a href="${base}" class="signOut"><i
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            ...
            <p>你好！<span class="userName" style="color: pink">${user.realname}</span>, 欢迎登录</p>
        </div>
        <!-- 搜索 -->
        ...
        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:;" data-url="${base}/static/page/main.html"><i class="layui-icon"
        ...
        <div class="layui-tab mag0" lay-filter="bodyTab" id="top_tabs_box">
            ...
            <div class="layui-tab-content clildFrame">
                <div class="layui-tab-item layui-show">
                    <iframe src="${base}/desk/toDeskManager.action"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="layui-footer footer">
        <p><span>copyright @2020 Wang</span></p>
    </div>
</div>
...
<script type="text/javascript">
    ...
    layui.use(['bodyTab', 'form', 'element', 'layer', 'jquery'], function () {
        ...
        tab = layui.bodyTab({
            ...
            url: "${base}/menu/loadIndexleftMenuJson.action" //获取菜单json地址
        });
