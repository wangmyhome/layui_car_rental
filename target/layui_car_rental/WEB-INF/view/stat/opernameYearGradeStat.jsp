...
<script type="text/javascript" src="${base}/static/echarts/js/echarts.min.js"></script>
<script type="text/javascript" src="${base}/static/echarts/js/jquery-3.1.1.min.js"></script>
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        function getData() {
            ...
            $.get("${base}/stat/loadOpernameYearGradeStatJson.action",{year:year},function (data) {
